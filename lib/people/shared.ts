...
export const profileRowSchema = z.object({
  ...
  home_address: z.string().nullable().optional().default(null),
  government_id_url: z.string().nullable().optional().default(null),
...
export function mapProfileRow(
  ...
  return {
    ...
    governmentIdUrl: row.government_id_url ?? null,
