...
function AnalyticsContent({ userRoles }: { userRoles: readonly UserRole[] }) {
  ...
  if (query.isPending) {
    return (
      <>
        <PageHeader title="Analytics" description="Executive dashboard for people, time off, payroll, and expenses." />
        <AnalyticsSkeleton />
      </>
    );
  }
  ...
  return (
    <>
      <PageHeader
        title="Analytics"
        description="Executive dashboard for people, time off, payroll, and expenses."
              ...
              <section className="analytics-metric-grid">
                <article className="metric-card">
                  ...
                  <p className="metric-value">
                    <CurrencyDisplay amount={data.payroll.metrics.lastRunGross} currency="USD" />
                  </p>
                ...
                <article className="metric-card">
                  ...
                  <p className="metric-value">
                    <CurrencyDisplay amount={data.payroll.metrics.lastRunNet} currency="USD" />
                  </p>
                  <p className="metric-hint">Last completed payroll run</p>
                </article>
                <article className="metric-card">
                  ...
                  <p className="metric-value">
                    <CurrencyDisplay amount={data.payroll.metrics.avgGrossSalary} currency="USD" />
                  </p>
                ...
                <article className="metric-card">
                  ...
                  <p className="metric-value">
                    <CurrencyDisplay amount={data.payroll.metrics.totalAllowances} currency="USD" />
                  </p>
          ...
          <article className="settings-card">
            ...
            <section className="analytics-metric-grid">
              ...
              <article className="metric-card">
                ...
                <p className="metric-value">
                  <CurrencyDisplay amount={data.expenses.metrics.reimbursedAmount} currency="USD" />
                </p>
